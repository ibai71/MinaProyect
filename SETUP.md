...
const CONFIG = {
    ...
    yourName: "James",
    messages: {
        subtitle: "you make every day brighter just by being in it âœ¨",
...
- Report issues in your own repository tracker
- Share ideas in your preferred channel
